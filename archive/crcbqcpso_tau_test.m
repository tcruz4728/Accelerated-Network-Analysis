...
function outResults = crcbqcpso_tau_test(inParams,psoParams,nRuns)
...
for lpruns = 1:nRuns
    ...
    phaseq0 = gen2PNwaveform_tau_test(params.fpos, estTa, 0, params.frange(1), params.frange(2), tau0,...
    ...
    %Estimated Signal
    estSigphase = gen2PNwaveform_tau_test(params.fpos, estTa, estPhase, params.frange(1), params.frange(2), tau0,...
