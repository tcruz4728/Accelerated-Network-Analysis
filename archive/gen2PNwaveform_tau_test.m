function wave = gen2PNwaveform_tau_test(fpos, ta, phase, fmin, fmax,tau0, tau1p5,datalen,initial_phase,snr,N, avec, normfac)
...
fwavepos = waveform_tau_test(fpos,ta,phase,fmin,fmax,tau0,tau1p5,datalen,initial_phase, avec);
