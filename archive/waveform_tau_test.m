function fwave = waveform_tau_test(fvec, t, phase, fmin, fmax,tau0, tau1p5,datalen,initial_phase,avec)
...
% function fwave = waveform_tau(inParams, ta_index,phase,qcCoefs)
