% function [mfVal, max_arg] = mfqc_tau(qcCoefs,params)
function [mfVal, max_arg] = mfqc_tau_test(x,params)
...
tau0 = x(1);
tau1p5 = x(2);
% phaseq0 = gen2PNwaveform_tau(params,0,0,qcCoefs,1);
phaseq0 = gen2PNwaveform_tau_test(params.fpos, 0, 0, params.frange(1), params.frange(2), tau0,...
