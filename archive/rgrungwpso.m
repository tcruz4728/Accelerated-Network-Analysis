...
%% Pre-processing
% [A,avec, phaseDiff] = gwpsoparams(fmin,fmax, fpos, datalen, N);
gwparams = gwpsoparams(pso,params);
A = gwparams.A;
avec = gwparams.avec;
phaseDiff = gwparams.phaseDiff;
